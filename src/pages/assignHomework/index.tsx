...
export default class App extends React.Component {
  ...
  genaratorTask = (data: any) => {
    ...
    return data.map((item: any, index: number) => {
      return (
        <option key={index} value={item.taskName}>
          {item.taskName}
        </option>
      );
    });
      ...
      <div>
              ...
              <div className="add-subject">
                ...
                <div className="subject-select">
                  <ul className="select-list">
                    <li>
                      <label>题型</label>
                      <select name="subjectType" onChange={this.changeValue}>
                    ...
                    <li>
                      <label>添加方式</label>
                      <select name="addType" onChange={this.changeValue}>
                    ...
                    <li className="chooseFromExam">
                      <button onClick={this.refreshSubject}>过滤</button>
                    </li>
                  </ul>
                </div>
              </div>
            </div>
            <button className="add-btn" onClick={this.addSubject}>
              +添加
            </button>
          </div>
          <div className="task-syllabus fr">
            <h3 className="title">作业大纲</h3>
            <ul className="syllabus-list"></ul>
            <div>
              <button
                className="submit"
                onClick={this.settingComplete}
                id="settingComplete"
              >
                完成
              </button>
        ...
        <div className={this.state.isShowSetTask ? "modal-mask" : "none"}>
          <div className="create-task">
            <Link to="/fore/personal/course/toClasswork">
              <i className="closeHomeworkSetting"></i>
            </Link>
            <div className="title">创建练习</div>
            <ul className="form-group">
              <li>
                <label className="form-label">
                  名称<b className="required">*</b>
                </label>
                <div className="form-control">
                  <input
                    ...
                    id="homeworkName"
                    name="homeworkName"
                    value={this.state.params.homeworkName}
              ...
              <li>
                ...
                <div className="form-control select">
                  ...
                  <p className="help-block none">
                    当前没有课程可布置
                    <a href="javascript:toAddCourse()">前往添加课程</a>
                  </p>
                </div>
              </li>
              <li className="taskLi">
                <label className="form-label">
                  任务<b className="required">*</b>
                </label>
                <div className="form-control select">
                  <select
                    name="task"
                  ...
                  <p className="help-block none">
                    当前没有任务可布置
                    <a href="javascript:toAddTask()">前往添加任务</a>
                  </p>
                </div>
              </li>
              <li className="teamLi" id="classLi">
                <label className="form-label">
                  班级<b className="required">*</b>
                </label>
                <Select
                  mode="multiple"
                  style={{ width: "100%" }}
              ...
              <li className="save-cancel">
                <button className="save" onClick={this.saveHomeworkInfo}>
                  确定
                </button>
              </li>
            </ul>
